...
const templates=JSON.parse(fs.readFileSync(new URL('src/registry/templates.json',base)))
const motions=JSON.parse(fs.readFileSync(new URL('src/registry/motions.json',base)))
const recipes=JSON.parse(fs.readFileSync(new URL('src/registry/recipes.json',base)))
const campaigns=JSON.parse(fs.readFileSync(new URL('src/registry/campaigns.json',base)))
let errors=[]
